...
public class EditDonor extends AppCompatActivity {
    TextInputEditText donor_name,donor_number,donor_area;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        donor_area.setText(area);
        donor_number.setText(phone);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(district_Map.containsKey(selectedDivison)){
                    ArrayAdapter<String> adapter_district =
                            new ArrayAdapter<>(EditDonor.this, android.R.layout.simple_list_item_1,district_Map.get(selectedDivison));
                    district.setText("");
        ...
        bad_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name_of_donor.isEmpty() ||
                    ...
                    Toast.makeText(EditDonor.this, "Please fill all fields", Toast.LENGTH_SHORT).show();
                    return;
                }

                if (phone_of_donor.length() != 11) {
                    Toast.makeText(EditDonor.this, "Enter valid phone number", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                    ...
                    public void onResponse(String s) {
                        if(s.contains("Congrats")){
                            ...
                            Toast.makeText(EditDonor.this,s,Toast.LENGTH_LONG).show();
                            ...
                            startActivity(new Intent(EditDonor.this,B_A_D_List.class));
                            finish();
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        new  AlertDialog.Builder(EditDonor.this)
                                .setTitle("Sign In")
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(EditDonor.this);
