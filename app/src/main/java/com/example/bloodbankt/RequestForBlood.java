            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (district_Map.containsKey(selectedDivison)) {
                    ArrayAdapter<String> adapter_district =
                            new ArrayAdapter<>(RequestForBlood.this, android.R.layout.simple_list_item_1, district_Map.get(selectedDivison));
                    district.setText("");
        ...
        rfb_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name_of_patient.isEmpty() ||
                        ...
                        time.isEmpty() ||
                        blood_group.isEmpty()) {
                    Toast.makeText(RequestForBlood.this, "Please fill all fields", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (phone_of_patient.length() != 11) {
                    Toast.makeText(RequestForBlood.this, "Enter valid phone number", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                    ...
                    public void onResponse(String s) {
                        ...
                        new AlertDialog.Builder(RequestForBlood.this)
                                .setTitle("Alert")
                                .setMessage(s)
                        ...
                        if (s.contains("Congrats")) {
                            Toast.makeText(RequestForBlood.this, s, Toast.LENGTH_LONG).show();
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(RequestForBlood.this);
